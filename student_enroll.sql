...
insert into student values('1BMS11CS001','A','Sr','19931230');
insert into student values('1BMS11CS002','B','Sr','19930924');
insert into student values('1BMS11CS003','C','Sr','19931127');
insert into student values('1BMS11CS004','D','Sr','19930413');
insert into student values('1BMS11CS005','E','Jr','19940824');
commit;
select * from student;
...
insert into enroll values('1BMS11CS001',115,3,100);
insert into enroll values('1BMS11CS002',114,5,100);
insert into enroll values('1BMS11CS003',113,5,100);
insert into enroll values('1BMS11CS004',111,5,100);
insert into enroll values('1BMS11CS005',112,3,100);
commit;
select * from enroll;
...
-- department
insert into textbook values(907,'UNIX CONCEPTS','TATA MCGRAW HILL','SUMITABHA DAS');
insert into book_adoption values(113,4,907);
